...
const BookList = () => {
  ...
  if (error) return <div className="p-2 bg flex justify-center items-center flex-col"><BiError className=" text-gray-300 text-[250px]" /><h3 className="text-gray-400 text-[20px]">Failed to Load Books</h3><span className="text-red-400 text-[20px]">{error.message}</span></div>;
